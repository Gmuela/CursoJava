...
public class DataBasePartidos {
    ...
    private Entrenador rui = new Entrenador("Rui Vitória", 40, R.mipmap.entrenador_rui,true);
    private Entrenador thomas = new Entrenador("Thomas Tuchel", 40, R.mipmap.entrenador_thomas,true);
    private Entrenador unai = new Entrenador("Unai Emery", 40, R.mipmap.entrenador_unai,true);
    private Entrenador luis = new Entrenador("Luis Enrique Martínez García", 40, R.mipmap.entrenador_luis,true);
    private Entrenador carlo = new Entrenador("Carlo Ancelotti", 40, R.mipmap.entrenador_carlo,true);
    private Entrenador arsene = new Entrenador("Arsène Wenger", 40, R.mipmap.entrenador_arsene,true);
    private Entrenador zidane = new Entrenador("Zinedine Zidane", 40, R.mipmap.entrenador_zidane,true);
    private Entrenador sarri = new Entrenador("Maurizio Sarri", 40, R.mipmap.entrenador_sarri,true);

    private Jugador ronaldo = new Jugador("Cristiano Ronaldo", 25, R.mipmap.jugador_ronaldo, 20, "Delantero");
    private Jugador benzema = new Jugador("Benzemá", 25, R.mipmap.jugador_benzema, 20, "Delantero");
    private Jugador isco = new Jugador("Men-isco", 25, R.mipmap.jugador_isco, 20, "Delantero");
    private Jugador marcelo = new Jugador("Marcelo", 25, R.mipmap.jugador_marcelo, 20, "Delantero");
    private Jugador modric = new Jugador("Modric", 25, R.mipmap.jugador_modric, 20, "Delantero");
    private Jugador morata = new Jugador("Morata", 25, R.mipmap.jugador_morata, 20, "Delantero");
    private Jugador navas = new Jugador("Navas-cerrada", 25, R.mipmap.jugador_navas, 20, "Portero");
    private Jugador ramos = new Jugador("Sergio Ramos", 25, R.mipmap.jugador_ramos, 20, "Delantero");
    private Jugador tio1 = new Jugador("El tio 1", 25, R.mipmap.jugador_tio_uno, 20, "Delantero");
    private Jugador tio2 = new Jugador("El tio 2", 25, R.mipmap.jugador_tio_dos, 20, "Delantero");
    private Jugador tio3 = new Jugador("El tio 3", 25, R.mipmap.jugador_tio_tres, 20, "Delantero");

    private List<Jugador> jugadores = Arrays.asList(ronaldo,benzema,isco,marcelo,modric,morata,navas,ramos,tio1,tio2,tio3);
